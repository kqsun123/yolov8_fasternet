...
from ultralytics.nn.backbone.EMO import *
from ultralytics.nn.mobilevitv3 import MobileViTBv3
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 C2f_Faster_EMA, C2f_DBB, GSConv, VoVGSCSP, VoVGSCSPC,FC2f,DC2f,DSConv,C2f_Faster_SA,FC2fSA,DWFC2f,GSFC2f,PConv,C2fSAConv,C2fGS):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, C2f_Faster, C2f_ODConv, C2f_Faster_EMA, C2f_DBB,
                     VoVGSCSP, VoVGSCSPC,FC2f,DC2f,C2f_Faster_SA,FC2fSA,DWFC2f,GSFC2f,C2fSAConv,C2fGS):
