...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/mnt/vip/lj/mydata/UTDAC2020/test/images', help='source directory for images or videos')
    parser.add_argument('--conf', type=float, default=0.25, help='object confidence threshold for detection')
    parser.add_argument('--iou', type=float, default=0.45, help='intersection over union (IoU) threshold for NMS')#原始0.7
    ...
    parser.add_argument('--name', type=str, default='UTDAC', help='experiment name (project/name)')
