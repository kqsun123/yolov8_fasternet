...
def get_params():
    params = {
        'weight': '/mnt/vip/hc/yolov8uw/best.pt',
        'cfg': '/mnt/vip/hc/yolov8uw/ultralytics/models/v8/yolov8s.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    #model(r'E:\\datasets\\RUOD\\test\\images\\006941.jpg', 'result/fasternet_t1/006941')
    params = get_params()
    model = yolov8_heatmap(**params)

    input_dir = '/media/sun/LJ009/images'
    output_dir = '/mnt/vip/hc/yolov8uw/result/8s'
    ...
    for image_name in os.listdir(input_dir):
        if image_name.lower().endswith(('.png', '.jpg', '.jpeg')):
            ...
            result_subdir = os.path.join(output_dir, os.path.splitext(image_name)[0])
            result_subdir = result_subdir.replace(' ', '_')  # Replace spaces with underscores
            print(result_subdir)
            model(image_path, result_subdir)
